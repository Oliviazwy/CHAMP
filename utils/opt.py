...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument('--in_features', type=int, default=72, help='size of each model layer')
        ...
        #                     Running options
        # ===============================================================
        self.parser.add_argument('--input_n', type=int, default=20, help='past frame number')
        ...
        self.parser.add_argument('--lr_now', type=float, default=0.00025)
